...
public class InsightService {
    ...
    private GeminiResquestDTO _createInsightRequest(String topic) {
        String systemInstructionText = "Você é uma IA especializada em copywriting. Auxilie na criação de uma descrição de post sobre o tema fornecido, com no máximo 2000 caracteres. Ofereça até 2 opções de descrição.";
